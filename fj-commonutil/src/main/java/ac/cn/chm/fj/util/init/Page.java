...
public class Page {
	...
	public String getPageStr3() {
		...
		if(totalResult>0){
			...
			sb.append("getCheackbox();");//chm_翻页时获取已选中的数据
			sb.append(" top.jzts();");
	...
	public String getPageStr() {
		StringBuffer sb = new StringBuffer();
			if(totalResult>0){
				...
				sb.append("&nbsp共<span class=\"color000\">" + totalResult + "</span>条\n") ;
				sb.append("</div>\n") ;
				//sb.append("	<li><a>共"+totalPage+"页</a></li>\n");
				if(currentPage==1){
					sb.append("<div class=\" layui-form-item\">\n") ;
					sb.append(" <a class=\"borderLHave hoverColorC\">首页</a>\n") ;
					sb.append(" <a class=\"borderLnone hoverColorC\">上一页</a>\n") ;
					sb.append("</div>\n") ;
				}else{
					sb.append("<div class=\" layui-form-item\">\n") ;
					sb.append(" <a class=\"borderLHave hoverColorC\" onclick=\"nextPage(1)\">首页</a>\n") ;
					sb.append(" <a class=\"borderLHave hoverColorC\" onclick=\"nextPage("+(currentPage-1)+")\">上一页</a>\n") ;
					sb.append("</div>\n") ;
				}
				sb.append("<div class=\"layui-form-item\">\n") ;
				sb.append(" <a class=\"borderLnone color000\">"+currentPage+"</a>\n") ;
				sb.append("</div>\n");
				if(currentPage==totalPage){
					sb.append("<div class=\" layui-form-item\">\n") ;
					sb.append(" <a class=\"borderLnone hoverColorC\">下一页</a>\n") ;
					sb.append(" <a class=\"borderLnone hoverColorC\">尾页</a>\n") ;
					sb.append("</div>\n") ;
				}else{
					sb.append("<div class=\" layui-form-item\">\n") ;
					sb.append(" <a class=\"borderLnone hoverColorC\" onclick=\"nextPage("+(currentPage+1)+")\">下一页</a>\n") ;
					sb.append(" <a class=\"borderLnone hoverColorC\" onclick=\"nextPage("+totalPage+")\">尾页</a>\n") ;
					sb.append("</div>\n") ;
				}
				sb.append("<div class=\" layui-form-item\">\n") ;
				sb.append(" <span class=\"floatL\">&nbsp转到&nbsp第</span>\n");
				sb.append("	   <input type=\"number\"  id=\"toGoPage\" autocomplete=\"off\" class=\"layui-input floatL borderradius3 color000\">\n");
				sb.append(" <span class=\"floatL\">页&nbsp</span>\n") ;
				sb.append(" <a class=\"borderE6 borderradius3\" id=\"skip\" onclick=\"toTZ();\">跳转</a>\n") ;
				sb.append("</div>\n");
